...
[![Build Status](https://travis-ci.org/legoktm/hound.svg?branch=master)](https://travis-ci.org/legoktm/hound)
...
```
go get github.com/legoktm/hound/cmds/...
```
...
2. Run 
```
docker run -d -p 6080:6080 --name hound -v $(pwd):/data legoktm/hound
```
...
```
git clone https://github.com/legoktm/hound.git ${GOPATH}/src/github.com/legoktm/hound
cd ${GOPATH}/src/github.com/legoktm/hound
make
```

If this is your only Go project, you can set your GOPATH just for Hound:
```
git clone https://github.com/legoktm/hound.git src/github.com/legoktm/hound
GOPATH=$(pwd) make -C src/github.com/legoktm/hound
```
